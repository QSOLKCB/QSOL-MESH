...
EXPECTED = {
    ...
    "phase-runtime-contract.v1.json":"qsol.mesh.phase-runtime-contract.v1",
...
expected_cuda_calibrated = {'schema': 'qsol.mesh.calibrated-plan-contract.v2',
 ...
 'cuda_host_evidence_status': 'retained-two-captures-at-69280c4'}
...
phase_runtime = loaded["phase-runtime-contract.v1.json"]
expected_phase_runtime = {'schema': 'qsol.mesh.phase-runtime-contract.v1',
 'contract_version': '1.0.0',
 'activation': ['mesh-run-smoke-phases', 'mesh-verify-smoke-phases'],
 'workload_identity': 'mesh-smoke-phases-v1',
 'request_bounds': {'phase_count': '1..=64',
                    'repeats': '1..=31',
                    'near_tie_bps': '0..=9999',
                    'minimum_cpu_phase_items': 1,
                    'minimum_cuda_phase_items': 2,
                    'total_phase_items': 'checked-u64-sum',
                    'calibration_items_per_phase': 'min(requested_calibration_items,phase_items)'},
 'planning': {'boundary': 'before-each-phase-after-previous-phase-verified',
              'candidate_budget_per_phase': 4,
              'cpu_contract': 'machine/calibrated-plan-contract.v1.json',
              'cuda_contract': 'machine/calibrated-plan-contract.v2.json',
              'fresh_measurements_every_phase': True,
              'full_work_confirmation_before_noncanonical_selection': True,
              'canonical_on_near_ties': True,
              'calibration_cache': False},
 'execution': {'selected_plan_executed_after_confirmation': True,
               'within_phase_replanning': False,
               'dynamic_work_stealing': False,
               'cuda_identity_stable_across_phases_and_execution': True,
               'failure_fallback': False,
               'partial_success_receipt': False,
               'phase_order_reduction': 'wrapping-u64',
               'separate_execution_scalar_oracle_required': True},
 'receipt': {'schema': 'qsol.mesh.phase-runtime-receipt.v1',
             'common_evidence_sections_required': True,
             'per_phase_calibration_receipts_required': True,
             'requested_and_effective_workers_required': True,
             'phase_geometry_required': True,
             'plan_change_count_required': True,
             'private_execution_provenance_required': True},
 'evidence_boundary': {'cuda_host_evidence_status': 'retained-capture-at-4ea2225',
                       'retained_evidence_manifest': 'evidence/phase5-cuda-host-2026-09-23/manifest.json',
                       'selected_cuda_phase_execution_observed': False,
                       'plan_changes_observed': 0,
                       'phase3_4_evidence_implies_phase5_execution': False,
                       'persistent_cuda_context': False,
                       'kernel_overlap_measured': False,
                       'universal_speedup': False}}
if phase_runtime != expected_phase_runtime:
    raise SystemExit("phase runtime admission, selection, or evidence contract drift")
expected_phase_workload = {'workload_id': 'mesh-smoke-phases-v1',
 'workload_contract_version': '1.0.0',
 'logical_domain': {'kind': 'ordered-list-of-independent-mesh-smoke-v1-instances',
                    'phase_count': '1..=64',
                    'phase_item_ids': '[0,phase_items)-restarted-for-each-phase',
                    'total_items': 'checked-u64-sum'},
 'partition_contract': {'between_phases': 'sequential-phase-index-order',
                        'within_phase': 'mesh-smoke-v1-contiguous-complete-cover'},
 'partial_result_contract': {'kind': 'one-wrapping-u64-checksum-per-phase'},
 'reduction_contract': {'kind': 'phase-index-order-wrapping-u64',
                        'calibration_results_are_workload_output': False},
 'verification_contract': {'kind': 'independent-scalar-reference-for-each-phase-and-ordered-sum',
                           'fail_closed': True},
 'exactness_contract': {'kind': 'bit-exact-u64'},
 'memory_contract': {'per_item_materialization': False,
                     'temporary_state': 'O(max_workers + bounded_phase_receipts)',
                     'maximum_retained_phases': 64,
                     'cuda_buffers': 'existing-executor-owned-per-call-lifetimes'},
 'side_effect_contract': {'kind': 'none'},
 'claim_boundary': 'synthetic-phase-sequence-only-not-GALAXY-or-universal-performance'}
if workloads["smoke-phases-v1.json"] != expected_phase_workload:
    raise SystemExit("phase workload semantics or bounded memory drift")
